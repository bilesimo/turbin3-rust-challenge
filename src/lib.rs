...
#[cfg(test)] 
mod tests {
  use solana_sdk::{signature::{Keypair, Signer, read_keypair_file}, transaction::Transaction, message::Message, system_program};
  use bs58;
  ...
  fn enroll () {
    ...
    let args = CompleteArgs {github: b"bilesimo".to_vec()};
